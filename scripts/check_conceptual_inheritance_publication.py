...
def main() -> int:
    ...
    if not isinstance(automation, dict):
        ...
        expected = {
            ...
            "route_receipt_path": "reports/optimization-target-publication-verification-receipt.json",
            "activation_receipt_writer": "scripts/write-public-activation-receipt.mjs",
            "activation_receipt_validator": "scripts/check-public-activation-receipt-writer.mjs",
            "activation_receipt_path": "reports/public-activation-receipt.json",
            "activation_receipt_artifact": "public-activation-receipt",
            "activation_closure_key": "activation_closures.conceptual_inheritance",
            "activation_closure_schema": "conceptual_inheritance_publication_closure.v1",
