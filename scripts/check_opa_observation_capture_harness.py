...
def main() -> int:
    failures: list[str] = []
    required_paths = [SCRIPT, PINNED_RUNNER, INDEPENDENT_RUNNER, SUMMARY_SCRIPT, COMPATIBILITY_RUNNER, GENERATED_VALIDATOR, RUNBOOK, POLICY, ALLOW_INPUT, DENY_INPUT, FIXTURE, WORKFLOW, WORKFLOW_MIRROR]
