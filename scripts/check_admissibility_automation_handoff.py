...
OBSERVER_RELATIVE_ADMISSIBILITY_CHECK = ROOT / "scripts" / "check_observer_relative_admissibility.py"
...
def main() -> int:
    ...
    checks = (
        ...
        (OBSERVER_RELATIVE_ADMISSIBILITY_CHECK, "observer-relative admissibility doctrine"),
