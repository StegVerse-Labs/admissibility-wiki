...
def main() -> int:
    ...
    checks = (
        (MESH_CHECK, "documentation mesh"), (ST016_PROMOTION_CHECK, "ST-016 promotion bundle"),
        (RUN_RECEIPT_CHECK, "automated transition run receipt"), (CONCEPTUAL_INHERITANCE_CHECK, "conceptual inheritance claims"),
        ...
        (GLOSSARY_CONSISTENCY_CHECK, "glossary consistency"), (ACTIVATION_SECTION_CHECK, "activation section"),
