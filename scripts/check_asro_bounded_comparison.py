...
def main() -> int:
    ...
    if reference.get("hash_scope") != "STEGVERSE_GENERATED_PUBLIC_METADATA_DERIVATIVE_NOT_SOURCE_INPUT":
        failures.append("manifest hash scope must remain limited to the public derivative")
