...
def main() -> int:
    ...
    receipt = {
        "schema": "stegverse.optimization_target_publication_verification_receipt.v0.10",
        ...
        "non_claims": [
            ...
            "Trend, trend-change, and trend-change-history reachability do not make predictive claims or grant authority.",
