...
def main() -> int:
    ...
    receipt = {
        "schema": "stegverse.optimization_target_publication_verification_receipt.v0.20",
        ...
        "non_claims": [
            ...
            "All frequency, recency, stability, change, and bounded-history reachability remains descriptive and does not make predictive or independent causal claims.",
