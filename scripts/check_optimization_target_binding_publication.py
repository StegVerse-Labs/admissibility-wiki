...
def main() -> int:
    failures: list[str] = []
    for path in (STATUS, DOCTRINE, FORMALISM, SIDEBAR, CHECKER):
        if not path.exists():
    ...
    for key in ("grants_execution_authority", "grants_cross_repository_mutation_authority", "grants_proof_authority"):
