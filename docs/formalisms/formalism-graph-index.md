---
title: Canonical Formalism Graph Index
---

# Canonical Formalism Graph Index

## Purpose

This page makes the current canonical formalism graph inspectable from one public page.

The graph index does not define, prove, validate, or supersede any formalism. It lists the public wiki mirror pages and the current extraction posture for each canonical source repository.
...
| [Core-Lite Admissibility Engine](./core-lite-admissibility-engine.md) | `Admissible-Existence/core-lite` | page + catalog + registry | source-confirmed implementation/test extraction |
| [Learning Transition Governance](./learning-transition-governance.md) | `Admissible-Existence/learning-transition-governance` | page + catalog + registry | source-confirmed learning-transition validation extraction |
| [Admissible-Existence Validation Factory](./admissible-existence-validation-factory.md) | `Admissible-Existence/ae-validation-factory` | page + catalog + registry | source-confirmed fixtures/expected-outcomes extraction |
...
This reading order is explanatory. It is not a canonical dependency order.

## Current Activation Boundary

The graph currently supports public orientation and relationship discovery.

It does not yet support a claim that all formalisms have source-confirmed mathematical definitions, proof candidates, validation candidates, publication artifacts, or reference implementations extracted into the wiki.
...
```text
This graph index does not define any formalism.
This graph index does not prove any formalism.
