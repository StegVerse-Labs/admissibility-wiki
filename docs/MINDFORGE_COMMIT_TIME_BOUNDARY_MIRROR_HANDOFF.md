...
docs/external-frameworks/mindforge.json
docs/external-frameworks/reports/mindforge.compatibility.json
...
NO comparative-testing claim before all reproducibility gates pass
```

## Validation commands

```bash
python scripts/check_external_framework_generated_surfaces.py
python scripts/check_mindforge_commit_time_boundary.py
python scripts/check_standing_determination_receipt.py
python scripts/check_mindforge_review_intake.py
python scripts/check_mindforge_publication_attribution_authorization.py
